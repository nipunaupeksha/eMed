    ...
    <section class="prescription__add section container" id="prescription-add">
        ...
        <div class="grid">
            <div class="form">
                ...
                <form action="{{route('prescription/update')}}" method="post" class="form__content">
                    @csrf
                    <h1 class="form__title">Update Prescription</h1>
                    ...
                    <div class="form__div">
                        ...
                        <div class="form__div-input">
                            ...
                            <input type="text" name="type" value="{{$info->type}}" placeholder="type" class="form__input">
                        </div>
                        <span></span>
                    ...
                    <div class="form__div">
                        ...
                        <div class="form__div-input">
                            ...
                            <input type="text" name="price" value="{{$info->price}}" placeholder="price" class="form__input">
                        </div>
                        <span></span>
                    ...
                    <div class="form__div">
                        ...
                        <div class="form__div-input">
                            ...
                            <input type="text" name="quantity" value="{{$info->quantity}}" placeholder="quantity" class="form__input">
                        </div>
                        <span></span>
                        <span class="form__error">@error('quantity'){{$message}} @enderror</span>
                    </div>
                    <input type="submit" class="form__button" value="Update Prescription">
                </form>
            </div>
        </div>
    </section>
