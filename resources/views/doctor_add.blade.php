        ...
        <div class="grid">
            <div class="form">
                ...
                <form action="add" method="post" class="form__content">
                    @csrf
                    <h1 class="form__title">Add Doctor</h1>
                    <div class="form__div">
                    ...
                    <div class="form__div">
                        ...
                        <div class="form__div-input">
                            ...
                            <input type="text" name="number" placeholder="number" class="form__input" value="{{old('number')}}">
                        </div>
                        <span></span>
                    ...
                    <div class="form__div">
                        ...
                        <div class="form__div-input">
                            ...
                            <input type="text" name="specialization" placeholder="specialization" class="form__input" value="{{old('specialization')}}">
                        </div>
                        <span></span>
                    ...
                    <div class="form__div">
                        ...
                        <div class="form__div-input">
                            ...
                            <input type="text" name="gender" placeholder="gender" class="form__input" value="{{old('gender')}}">
                        </div>
                        <span></span>
                    ...
                    <div class="form__div">
                        ...
                        <div class="form__div-input">
                            ...
                            <input type="text" name="address" placeholder="address" class="form__input" value="{{old('address')}}">
                        </div>
                        <span></span>
                    ...
                    <div class="form__div">
                        ...
                        <div class="form__div-input">
                            ...
                            <input type="text" name="contact" placeholder="contact" class="form__input" value="{{old('contact')}}">
                        </div>
                        <span></span>
                        <span class="form__error">@error('contact'){{$message}} @enderror</span>
                    </div>
                    <input type="submit" class="form__button" value="Add Doctor">
                </form>
            </div>
        </div>
    </section>
