    ...
    <section class="room__add section container" id="room-add">
        ...
        <div class="grid">
            <div class="form">
                ...
                <form action="{{route('room/update')}}" method="post" class="form__content">
                    @csrf
                    <h1 class="form__title">Update Room</h1>
                    ...
                    <div class="form__div">
                        ...
                        <div class="form__div-input">
                            ...
                            <input type="text" placeholder="room category" name="category" class="form__input" value="{{$info->category}}">
                        </div>
                        <span></span>
                    ...
                    <div class="form__div">
                        ...
                        <div class="form__div-input">
                            ...
                            <input type="text" placeholder="room status" name="status" class="form__input" value="{{$info->status}}">
                        </div>
                        <span></span>
                        <span class="form__error">@error('status'){{$message}} @enderror</span>
                    </div>
                    <input type="submit" class="form__button" value="Update Room">
                </form>
            </div>
        </div>
    </section>
